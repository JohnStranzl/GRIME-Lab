...
<div class="panel-container">
  <div class="panel">
    ...
    <p align="center">
      ...
      <body>
        <button onclick="openFile()">Open File</button> <pre id="fileContent"></pre> <script> function openFile() { fetch('https://journals.plos.org/water/article?id=10.1371/journal.pwat.0000032') .then(response => response.text()) .then(data => { document.getElementById('fileContent').textContent = data; }) .catch(error => { console.error('Error fetching the file:', error); }); } </script>
      </body>
    </p>
  </div>
